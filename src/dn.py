import torch
from src.utils import inverse_sigmoid
...
def get_contrastive_denoising_training_group(
    ...
    if box_noise_scale > 0:
        known_bbox = ops.box_convert(input_query_bbox, in_fmt="cxcywh", out_fmt="xyxy")
        ...
        input_query_bbox = ops.box_convert(known_bbox, in_fmt="xyxy", out_fmt="cxcywh")
